...
- [ ] G003b / P0-01: Independent browser/mobile/print QA for the exact PR head (this branch). Check the new quiz's keyboard/mobile flow, the new print stylesheet output, long CTA wrapping on narrow phones, and calculator interactions.
...
- [ ] G009 (new, 2026-09-17): Swap the 7 provisional batch2 illustrations for root's cleaner replacement batch when ready (current batch has a visible glow/vignette and is explicitly provisional).
